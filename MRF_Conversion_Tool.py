...
masterCodes = ["J1745", "99393", "82607", "A7037"]
        ...
        if i["billing_code"] == j:
            ...
            for k in i["negotiated_rates"]:
                for l in k["provider_references"]:
                    ...
                    #entriesDict.append({'provider_reference_' + str(providerRefCount): str(k["provider_references"][0])})
                    ...
                    for l in k["negotiated_prices"]:
                        ...
                        # Determine if a column exists for reference sub rate
                        # If first rate of this provider, get the index of the column for this provider reference + 1
                        #       then insert new columns for rate and class sub reference sub rate count
                        ...
                        if fields.count('negotiated_rate_' + str(providerRefCount) + '_' + str(rateAndClassCount)) == 0:                                
                            ...
                            #fields.append('negotiated_rate_' + str(providerRefCount) + '_' + str(rateAndClassCount))
                            #fields.append('billing_class_' + str(providerRefCount) + '_' + str(rateAndClassCount))
